    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/manage/circuit')) {
            ...
            if ($pathinfo === '/manage/circuit/new') {
                return array (  'circuitid' => NULL,  '_controller' => 'AppBundle\\Controller\\AdminController::newAction',  '_route' => 'admin_circuit_new',);
            }

            // admin_circuit_edit
            if (preg_match('#^/manage/circuit/(?P<circuitid>[^/]++)/edit$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_circuit_edit')), array (  'circuitid' => NULL,  '_controller' => 'AppBundle\\Controller\\AdminController::newAction',));
            }

            // admin_circuit_remove
            if (preg_match('#^/manage/circuit/(?P<circuitid>[^/]++)/remove$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_circuit_remove')), array (  'circuitid' => NULL,  '_controller' => 'AppBundle\\Controller\\AdminController::delAction',));
            }
